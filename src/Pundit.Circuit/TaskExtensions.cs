...
namespace Pundit.Circuit
{
    ...
    {
        public static Task<TResult> TimeoutAfter<TResult>(this Task<TResult> task, TimeSpan timeout, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public static Task TimeoutAfter(this Task task, TimeSpan timeout, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Short-circuit #1: infinite timeout or task already completed
            if (task.IsCompleted || (timeout == TimeSpan.MaxValue))
            {
